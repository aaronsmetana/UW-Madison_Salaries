...
import { IconDatabase, IconCoin, IconReportMoney, IconScale, IconUsersGroup, IconArrowRight } from '@tabler/icons-react';
  ...
  return (
    <Box style={{ minHeight: 'calc(100dvh - 200px)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      <Stack gap="xl" w="100%">
        ...
        {/* Hero search + grouped system-wide stats, sharing one centered width. */}
